  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute -top-20 left-10 w-[250px] h-[250px] bg-cyan-700/20 blur-3xl rounded-full"></div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center mt-20">
          ...
          <div className="mx-auto w-24 h-1 bg-gradient-to-r from-cyan-400 to-blue-500 mb-8 rounded-full animate-pulse"></div>
          ...
          <p className="text-lg text-gray-300 leading-relaxed px-2">
            ...
            I enjoy exploring how <span className="text-cyan-400 font-medium">algorithms and real-world systems</span> can work together to solve practical problems.
          </p>

          <p className="text-lg text-gray-300 leading-relaxed px-2 mt-4">
            My interests span across <span className="text-cyan-400 font-medium">Data Structures & Algorithms</span> and
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-12">
            <div className="bg-cyan-800/10 p-6 rounded-xl border border-cyan-800/20 hover:border-cyan-400/40 hover:scale-105 transition transform duration-300">
          ...
          <div className="mt-12">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                <span
                  key={item}
                  className="px-4 py-2 bg-cyan-800/20 border border-cyan-700/30 rounded-full text-sm text-gray-300 hover:bg-cyan-700/30 transition duration-300"
                >
                  {item}
                </span>
              ))}
          ...
          <div
            ...
            data-aos-delay="200"
          >
            <h2 className="text-2xl sm:text-3xl font-semibold mb-8 text-cyan-300">
              Education
            </h2>

            <div className="bg-cyan-800/10 p-5 rounded-lg border border-cyan-800/20 shadow-md hover:border-cyan-500/30 hover:scale-105 transition transform duration-300 ease-in">
