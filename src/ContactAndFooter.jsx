    ...
    <section id="contact" className="py-20 px-6 bg-black relative text-white">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex justify-center gap-6 text-2xl">
          <a href="mailto:jhanvi@example.com" className="hover:text-purple-400" title="Email">
            <FaEnvelope />
          </a>
          <a href="https://github.com/yourusername" target="_blank" rel="noreferrer" className="hover:text-purple-400" title="GitHub">
            <FaGithub />
          </a>
          <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noreferrer" className="hover:text-purple-400" title="LinkedIn">
            <FaLinkedin />
          </a>
        </div>
      </div>
